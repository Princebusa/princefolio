    ...
    <div className="dots-bg max-width relative after:content-[''] after:w-[1px] after:h-[100%] after:left-[0] after:top-0 after:absolute after:bg-[var(--edge-line)] before:content-[''] before:w-[1px] before:h-full before:right-[0] before:bottom-0 before:absolute before:bg-[var(--edge-line)]">
      ...
      <div className="relative">
        <motion.img
          ...
          className=" w-[120px] h-[120px] border-[4px] border-transparent shadow-[0_0_0_1px_#e4e4e7] dark:shadow-[0_0_0_1px_#202029] "
          src={prince}
          alt=""
        />
        <motion.div
      ...
      <div>
        <motion.h2
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.3, ease: "easeOut"}}
          className="max-md:flex flex-col font-bold md:text-[30px] text-[25px] text-[#09090b] dark:text-[#e5e5e5] tracking-[-.4px]"
        >
          Prince Busa{" "}
