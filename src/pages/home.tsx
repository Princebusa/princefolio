...
export default function Home() {
  return (
    <>
      <section className="mt-[43px] relative before:z-10 before:content-[''] before:w-full before:h-[1px] before:left-0 before:bottom-0 before:absolute before:bg-[var(--edge-line)]">
